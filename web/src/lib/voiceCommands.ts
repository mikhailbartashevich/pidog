...
const ru: AliasMap = {
  ...
  follow_ai_target: ['следи через аи', 'следи через ai', 'найди человека через аи'],
  stop_ai_target: ['останови аи слежение', 'останови ai слежение', 'не следи через аи'],
...
const en: AliasMap = {
  ...
  follow_ai_target: ['follow through ai', 'find person through ai', 'follow known person'],
  stop_ai_target: ['stop ai tracking', 'stop following through ai'],
